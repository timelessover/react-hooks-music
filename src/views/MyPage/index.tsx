...
const Index = (props: any) => {
    ...
    const { likeSongs = '', playHistorys = '' } = props.appStore
            ...
            <div className={style.section}>
                <ul>
                    ...
                    <li>
                        ...
                        <div className={style.title} onClick={() => goTo('/history?isHistory=1')}>播放历史</div>
                        <div className={style.number}>{playHistorys.length}首</div>
                        <div className={`iconfont icon-bofang ${style.suffix}`} />
                    </li>
                    <li>
                        <div className={`iconfont icon-xihuan ${style.prefix}`} style={{ color: '#f0437e' }} />
                        <div className={style.title} onClick={() => goTo('/history')}>我的喜欢</div>
